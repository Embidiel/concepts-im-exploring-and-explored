...
console.log(PROTO_DIR);

// Deep Delete before building TS Protocol Buffer Models
...
const executionPath = `${PROTOC_PATH} ${protoConfig.join(' ')}`;

shell.exec(executionPath, (code, stdout, stderr) => console.log('Proto', code, stdout, stderr));
